...
replace (
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.32.9
	k8s.io/endpointslice => k8s.io/endpointslice v0.32.9
...
require (
	...
	github.com/harvester/harvester v1.7.0-dev-20251026.0.20251028055051-a9efdf23d3a3
